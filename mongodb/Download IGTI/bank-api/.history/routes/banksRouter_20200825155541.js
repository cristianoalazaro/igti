...
router.patch("/account/transfer/", async (req, res, next) => {
  try {
    ...
    console.log("Inicio source: " + sourceAccount);
    console.log("Inicio target: " + targetAccount);
    ...
    console.log("Fim source: " + sourceAccount);
    console.log("Fim target: " + targetAccount);
